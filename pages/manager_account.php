    ...
    <div class="row g-3 mb-4 mx-3">
        ...
        <div class="col-md-3">
            <div class="card shadow-sm border-0 bg-warning">
                <div class="card-body text-center">
                    <h6 class="mb-1">Manager Self</h6>
                    <h4 class="mb-0">৳ <?= number_format($manager_self_total, 2) ?></h4>
                </div>
            </div>
        </div>
        <div class="col-md-3">
            <div class="card shadow-sm border-0 bg-danger text-white">
                <div class="card-body text-center">
                    <h6 class="mb-1">Manager Expense</h6>
                    <h4 class="mb-0">৳ <?= number_format($expense_total, 2) ?></h4>
                </div>
            </div>
        </div>
        <div class="col-md-3">
            <div class="card shadow-sm border-0 bg-success text-white">
                <div class="card-body text-center">
                    <h6 class="mb-1">Manager Net Paid</h6>
                    <h4 class="mb-0">৳ <?= number_format(max($manager_net_paid, 0), 2) ?></h4>
                </div>
            </div>
        </div>
    </div>
                        ...
                        <tr>
                            ...
                            <td>
                                <?php if (mysqli_num_rows($history_sql) == 0): ?>
                                    <span class="text-muted">No Manager Payment</span>
                                <?php else: ?>
